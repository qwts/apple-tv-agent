...
Production status/capabilities and [core controls](controls.md) are available. From a checkout, verify persisted credentials in a separate process without pairing or device control:
