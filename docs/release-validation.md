...
| Skill | Portable folder and fake-CLI scenarios verified; see [skill validation](skill-validation.md) | Walkthroughs performed by the implementing agent, not independent model evaluation or actual client installation |
