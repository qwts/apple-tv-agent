...
- `devices alias --device UUID --name living-room` adds a unique, case-sensitive alias. Repeating it is idempotent. An alias cannot equal any registered UUID or another device's alias. Unicode and spaces are preserved.
